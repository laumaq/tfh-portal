...
export default function ConnexionExternePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 3. VÉRIFICATION TÉLÉPHONE (OBLIGATOIRE)
      if (!telephone.trim()) {
        setError('Le numéro de téléphone est obligatoire pour les nouveaux utilisateurs');
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
            ...
            <>
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Format recommandé : +32 XXX XX XX XX
                </p>
              </div>
            </>
          )}
        ...
        {/* Section informations et confidentialité */}
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>• L'email et le téléphone sont obligatoires pour la création de compte</li>
              <li>• Si vous avez oublié votre mot de passe, contactez un coordinateur</li>
            </ul>
          </div>

          {/* NOUVELLE SECTION : Confidentialité des données */}
          <div className="mt-4 bg-blue-50 p-4 rounded-lg border border-blue-100">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-blue-800 text-sm">Confidentialité des données</h3>
                <p className="text-sm text-blue-700 mt-1">
                  Seuls les membres de l'équipe de coordination ont accès à votre email et numéro de téléphone. 
                  Ces données ne seront utilisées que pour vous contacter par rapport aux TFH à l'
                  <strong> Athénée communal Léonie de Waha</strong>.
                </p>
              </div>
            </div>
          </div>
